...
const Services = {
    ...
    getAnimeEpisode: async (req, res) => {
        ...
        try {
            ...
            obj.date = $(".kategoz > .fa fa-clock-o").find('span').text().trim(); // Perbaikan: Menggunakan trim() untuk menghilangkan spasi kosong dan text() untuk mendapatkan teks tanggal episode
            obj.baseUrl = url;
