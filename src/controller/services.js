...
const Services = {
    ...
    getAnimeEpisode: async (req, res) => {
        ...
        try {
            ...
            obj.idanime = $(".alertalert-info > li").attr('href').replace(`${baseUrl}/anime/`, "").replace(`${baseUrl}/episode/`, "").replace("/", ""); // Perbaikan: Menggunakan baseUrl untuk menggantikan url.baseUrl dan menghilangkan kesalahan sintaks
