...
const Services = {
    ...
    getAnimeEpisode: async (req, res) => {
        ...
        try {
            ...
            obj.date = $(".kategoz").text().replace(`Posted by aoichi`, "").text().replace(`  `, ""); // Perbaikan: Menggunakan trim() untuk menghilangkan spasi kosong dan text() untuk mendapatkan teks tanggal episode
            obj.baseUrl = url;
