...
const Services = {
    ...
    getAnimeEpisode: async (req, res) => {
        ...
        try {
            ...
            obj.date = $(".kategoz").replace(`Posted by aoichi`,"").text() // Perbaikan: Menggunakan trim() untuk menghilangkan spasi kosong dan text() untuk mendapatkan teks tanggal episode
            obj.baseUrl = url;
