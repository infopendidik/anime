...
const Services = {
    ...
    getAnimeEpisode: async (req, res) => {
        ...
        try {
            ...
            obj.idanime = $(".alert.alert-info").attr('href').replace(`${baseUrl}`, ""); // Perbaikan: Menggunakan baseUrl untuk menggantikan url.baseUrl dan menghilangkan kesalahan sintaks
